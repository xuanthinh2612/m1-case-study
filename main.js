...
function runGame() {
    ...
    for (let i = 0; i < demoUfo.ufo.length; i++) {
        ...
        ctx.drawImage(fire, demoUfo.ufo[i].x - 15, demoUfo.ufo[i].y + ufoDistance + 80, size, size+100);
        ctx.drawImage(ufo2, demoUfo.ufo[i].x, demoUfo.ufo[i].y + ufoDistance, size, size);
        ...
        if (demoPlane.checkLose(i,demoUfo.ufo) === false) {
